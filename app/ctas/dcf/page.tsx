...
function getCachedData(): AlphaVantageResp | null {
  try {
...
function setCachedData(data: AlphaVantageResp): void {
  try {
  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        // Set defaults from fresh data
        setDefaultAssumptions(json);
    ...
    function setDefaultAssumptions(json: AlphaVantageResp) {
